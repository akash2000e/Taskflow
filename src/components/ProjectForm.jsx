...
export default function ProjectForm({ project, onClose }) {
  ...
  return (
    ...
    >
      <div className="bg-[#1C1C1C] w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl border border-border shadow-2xl max-h-[calc(100vh-9rem)] sm:max-h-[90vh] overflow-y-auto">
